...
//////////SAVEEEE PRODUCT WITH IMAGE
	...
	//yekhou file men angular w yekhdhou m dossier images w yetransferih ghadi(yekhou bytes w nom w yhotou)
			...
			JsonMappingException , Exception
	{
		...
		try
		{
			...
			FileUtils.writeByteArrayToFile(serverFile,file.getBytes());//chnjib lfichier men ay pc w n enregisrih fl dossier mteai
		}catch(Exception e) {
			e.printStackTrace();
		}
