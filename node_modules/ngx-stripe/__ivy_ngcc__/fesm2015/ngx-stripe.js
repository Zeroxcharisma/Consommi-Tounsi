...
StripeCardComponent.ɵfac = function StripeCardComponent_Factory(t) { return new (t || StripeCardComponent)(ɵngcc0.ɵɵdirectiveInject(StripeService)); };
StripeCardComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: StripeCardComponent, selectors: [["ngx-stripe-card"]], viewQuery: function StripeCardComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.stripeCard = _t.first);
    } }, inputs: { options: "options", elementsOptions: "elementsOptions", stripe: "stripe" }, outputs: { card: "card", on: "on" }, decls: 2, vars: 0, consts: [[1, "field"], ["stripeCard", ""]], template: function StripeCardComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(StripeCardComponent, [{
  ...
  `
    ...
    }], function () { return [{ type: StripeService }]; }, { card: [{
            type: Output
        }], on: [{
            type: Output
        }], options: [{
...
NgxStripeModule.ɵinj = ɵngcc0.ɵɵdefineInjector({});
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxStripeModule, { declarations: [StripeCardComponent], exports: [StripeCardComponent] }); })();
