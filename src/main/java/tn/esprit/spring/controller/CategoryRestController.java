...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	//  http://localhost:9091/SpringMVC/servlet/retrieve-cat-by-id/{id}
...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	//http://localhost:9091/SpringMVC/servlet/retrieve-by-name/{nameCat}
...
//		@PreAuthorize("hasAuthority('ADMINISTRATOR') or hasAuthority('DEPARTMENTMANAGER')")
	...
	///LES METIERS(affectations)

		
		//http://localhost:9091/SpringMVC/servlet/affect-undercategory-to-category/{Iduc}/{Idc}
//		@PreAuthorize("hasAuthority('ADMINISTRATOR') or hasAuthority('DEPARTMENTMANAGER')")
		@PutMapping("affect-undercategory-to-category/{Iduc}/{Idc}")
		public void affecterProduitARayon(@PathVariable(value = "Iduc") int Iduc,@PathVariable(value = "Idc") int idCategory)
		{
